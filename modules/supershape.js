...
const presets = [
  // codevember 2017
  {
    a: { m: 5.9, n1: 2.7, n2: 4.7, n3: 7.4, a: 1.2, b: 0.8 },
    b: { m: 17, n1: 35, n2: 14, n3: -15, a: 1.8, b: 2 },
  },
  // sphere
  {
    a: { m: 0.01, n1: 0.1, n2: 0.01, n3: 5 },
    b: { m: 0.01, n1: 0.1, n2: 0.01, n3: 5 },
  },
  // rounded cube
  {
    a: { m: 4, n1: 10, n2: 10, n3: 10 },
    b: { m: 4, n1: 10, n2: 10, n3: 10 },
  },
  // doughboy sextuplets
  {
    a: { m: 6, n1: -4.8, n2: 7.54, n3: 6.4 },
    b: { m: 11.43, n1: 1.5, n2: 0, n3: 5.9 },
  },
];
